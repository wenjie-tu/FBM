...
ccf(alpha_low, beta_low, main="Crosscorrelation plot of alpha and beta (low)")
ccf(alpha_middle, beta_middle, main="Crosscorrelation plot of alpha and beta (middle)")
ccf(alpha_high, beta_high, main="Crosscorrelation plot of alpha and beta (high)")
```
