...
truehist(mu_gibbs_samples, prob=TRUE, col="yellow", xlab=expression(mu), main = "Mean")
...
truehist(sigma2_gibbs_samples, prob=TRUE, col="yellow", xlab=expression(sigma^2), main = "Variance")
...
# plot for precision
truehist(inv_sigma2_gibbs_samples, prob=TRUE, col="yellow", xlab=expression(1/sigma^2), main = "Precision")
