...
Explain Metropolis-Hastings sampler
...
ccf(alpha_low, beta_low, col=2, main="Crosscorrelation plot of alpha and beta (low)")
ccf(alpha_middle, beta_middle, col=3, main="Crosscorrelation plot of alpha and beta (middle)")
ccf(alpha_high, beta_high, col=4, main="Crosscorrelation plot of alpha and beta (high)")
```
