...
The p-values of the Heidelberg diagnostics have slightly changed. One test has now even failed (alpha 3).
...
```
The obtained absolute values for $\alpha$ and $\beta$ are all below 2, which indicates convergence to the target distribution. The plot shows that for the third and fourth chain some z-scores lie above and one below 2.0. 
...
The univariate potential scale reduction factors for both alpha and beta are close to 1. Compared to the original model the effective sample size has been increased from 16766.74 to 29704.35.
