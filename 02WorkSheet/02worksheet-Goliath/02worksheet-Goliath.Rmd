---
title: "Worksheet 2"
author: 'Goliath : Wenje Tu, Lea Bührer, Jerome Sepin, Zhixuan Li'
...
{\int_{-\infty}^{\infty}\exp\left(-\frac{n\kappa+\lambda}{2}\left(m-\frac{\kappa n\bar{y}+\lambda\mu}{n\kappa+\lambda} \right)^2  \right)dm}  \\
&= \frac{\exp\left(-\frac{n\kappa+\lambda}{2}\left(m-\frac{\kappa n\bar{y}+\lambda\mu}{n\kappa+\lambda} \right)^2  \right)}
{\frac{1}{\sqrt{\frac{n\kappa+\lambda}{2\pi}}} \underbrace{\int_{-\infty}^{\infty}\sqrt{\frac{n\kappa+\lambda}{2\pi}}\exp\left(-\frac{n\kappa+\lambda}{2}\left(m-\frac{\kappa n\bar{y}+\lambda\mu}{n\kappa+\lambda} \right)^2  \right)dm}_\text{integrates to 1}}  \\
