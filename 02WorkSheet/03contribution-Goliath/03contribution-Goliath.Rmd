...
**Task:** Write a short program in R to estimate the area of the unit circle $x^2+y^2=1$ by randomly dropping points (independent Monte Carlo sampling) on it.
...
* The estimated area of the unit circle is simply the product of the ratio and the area of the square.
