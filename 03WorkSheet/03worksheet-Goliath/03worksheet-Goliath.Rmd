...
```{r, eval=FALSE}
curve(dnorm(x, mean=164.558, sd=sqrt(34.80663)), ylim=c(0, 0.07), xlim=c(120, 200), 
...
curve(dnorm(x, mean=161, sd=sqrt(970)), ylim=c(0, 0.015), xlim=c(61, 261), col=3, 
      lwd=2, xlab="Height", ylab="Density", main="Prior (Posterior) predictive distribution")
...
```{r, fig.show="hold", out.width="33.3%", eval=FALSE}
