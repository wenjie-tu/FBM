...
```{r, fig.show="hold", out.width="50%", fig.align='center', fig.cap="Posterior Predictive Distribution"}
curve(dnorm(x, mean=164.558, sd=sqrt(934.80663)), ylim=c(0, 0.015), xlim=c(61, 261), col=4, 
      lwd=2, xlab="Height", ylab="Density", main="")
```
...
```{r, fig.show="hold", out.width="50%", fig.align='center', fig.cap="Comparison of Posterior, Prior Predictive and Posterior Predictive Distribution for Height."}
